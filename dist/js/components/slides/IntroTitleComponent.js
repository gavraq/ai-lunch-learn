// Introduction Title Component
class IntroTitleComponent extends BaseComponent {
    
    createContent() {
        const container = document.createElement('div');
        container.className = 'intro-title-container';
    ...
    initialize() {
        ...
        console.log('IntroTitleComponent initialized');
        this.initialized = true;
    }
    
    cleanup() {
        console.log('IntroTitleComponent cleanup');
